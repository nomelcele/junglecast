...
public class SearchVO {
	...
	public void setArticle_share(int article_share) {
		this.article_share = article_share;
	}
	public int getArticle_reply() {
		return article_reply;
	}
	public void setArticle_reply(int article_reply) {
